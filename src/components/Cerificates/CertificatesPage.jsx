...
const certifications = [
	{
		...
		summary: 'Applied Generative AI and production-grade ML workflows on AWS.',
		skills: ['AI & Generative AI', 'Cloud-Based ML Deployment', 'Security & Compliance'],
	...
	},
	{
		...
		summary: 'Validated expertise in building, operationalizing, and securing end-to-end ML solutions on AWS Cloud.',
		skills: ['Production ML Deployment', 'MLOps & Model Monitoring', 'Data Engineering for ML'],
								...
								<div>
									...
									<div className="flex flex-wrap gap-2">
										...
										{cert.skills.length > 3 && (
											<span className="px-3 py-1 rounded-full text-xs bg-slate-800 text-slate-300">+{cert.skills.length - 3}</span>
											)}
									</div>
								</div>
