...
const skillCategories = [
  ...
  {
    category: 'AI/ML',
    items: ['PyTorch', 'TensorFlow', 'OpenCV', 'Hugging Face', 'Computer Vision'],
    icon: '🧠'
  },
  {
    category: 'Backend',
    items: ['Java', 'Python', 'Spring Boot', 'Node.js', 'REST APIs'],
    icon: '⚙️'
  },
  {
    ...
    <section className="container mx-auto">
      <div className="text-center mb-10">
        ...
        <p className="text-slate-400 max-w-2xl mx-auto">
          A broad range of technologies and frameworks across software engineering, cloud infrastructure, and machine learning
        </p>
      </div>
