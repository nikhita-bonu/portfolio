...
const experiences = [
	{
		...
		highlights: [
			...
			'Reduced database query latency by 90% through performance optimization.',
		],
	},
	{
		role: 'AI/ML Engineer',
		...
		highlights: [
			...
			'Built production-ready ML pipelines with automation integration.',
		],
	},
]
		...
		<section className="container mx-auto">
			<div className="text-center mb-10">
				...
				<p className="text-slate-400 max-w-2xl mx-auto">
					Combining production-grade backend engineering with cutting-edge machine
					learning research
				</p>
			</div>
